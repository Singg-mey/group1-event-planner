            ...
            <NavigationMenu align="start">
              <NavigationMenuList className="gap-1">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="col-span-2 flex items-center justify-between border-b border-border/50 pb-2">
                        ...
                        <a
                          href="#find-event-all"
                          onClick={() =>
                            handleItemClick("Find Event", "#find-event-all")
                          }
                      ...
                      {EVENT_CATEGORIES.map((cat) => {
                        ...
                        return (
                          <NavigationMenuLink
                            ...
                            href={cat.href}
                            onClick={() =>
                              handleItemClick("Find Event", cat.href)
                            }
                ...
                <NavigationMenuItem>
                  ...
                  {/* Keep the creation options available from the quick-create action below. */}
                  <NavigationMenuContent className="hidden w-[380px] p-3">
